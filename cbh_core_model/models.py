...
class SkinningConfig(SingletonModel):
    ...
    login_page_title = models.CharField(max_length=300, default="Welcome to SGC Global ChemiReg", help_text="Text to use as the login page title")
    login_page_subtitle = models.CharField(max_length=300, default="Home of SGC Compound Registration", help_text="Text to use as the login page subtitle")
